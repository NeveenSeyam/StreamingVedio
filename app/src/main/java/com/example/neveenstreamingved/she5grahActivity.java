...
public class she5grahActivity extends AppCompatActivity {
    PlayerView playerView;
    SimpleExoPlayer player;
    private int CurrentWindow = 0;
    private boolean PlayWhenReady = true;
    private long playerff = 0;
    String streamingVidoURL = "https://www.youtube.com/watch?v=umR6MU1y5G4";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_she5grah);
        playerView = findViewById(R.id.vidoView3);
